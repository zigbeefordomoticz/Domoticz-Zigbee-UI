...
import { DetailTopologyComponent } from './detail-topologie/detail-topologie.component';
...
@NgModule({
  ...
  declarations: [NetworkComponent, NwkStatsComponent, TopologyComponent, DetailTopologyComponent],
  providers: [
